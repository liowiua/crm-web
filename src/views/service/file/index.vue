  ...
  <div class="app-container">
    ...
    <el-scrollbar class="table-container" >
      <el-table ref="flashTable"
        ...
        <el-table-column label="分配人" width="120" align="center">
          <template slot-scope="scope">{{scope.row.assigner}}</template>
        </el-table-column>
        <el-table-column label="分配时间" width="120" align="center">
          <template slot-scope="scope">{{scope.row.assignTime | formatDate}}</template>
        </el-table-column>
        <el-table-column label="处理人" width="120" align="center">
          <template slot-scope="scope">{{scope.row.serviceProcePeople}}</template>
        </el-table-column>
        <el-table-column label="处理时间" width="120" align="center">
          <template slot-scope="scope">{{scope.row.serviceProceTime | formatDate}}</template>
        </el-table-column>

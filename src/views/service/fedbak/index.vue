    ...
    <el-dialog
      ...
      <el-form :model="service"
        ...
        <el-form-item label="服务评价">
          <el-input v-model="service.serviceProceResult" 
                    type="textarea"
                    :rows="2"
                    placeholder="请输入内容"
        ...
        <el-form-item label="满意度">
          <el-rate v-model="service.myd" ></el-rate>
        </el-form-item>
      </el-form>
...
<script>
import {fetchList,  feedBackService} from '@/api/service';//
  ...
  methods: {
    ...
    handleDialogConfirm() {
      this.$confirm('是否提交反馈?', '提示', {
        ...
        feedBackService(this.service).then(() => {
          this.$message({
            message: '处理成功！',
            type: 'success'
          });
